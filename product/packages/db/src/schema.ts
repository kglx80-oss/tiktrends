...
export const brands = pgTable('brands', {
  ...
  // Une date de synchro PAR connecteur · un flux Shopify et un flux Meta se
  // rafraîchissent séparément, un horodatage partagé mentait sur la fraîcheur de
  // l'autre (N09). Voir 0050.
