...
/** Enregistre les règles créatives maison (EDEN) de la marque active. Injectées dans chaque génération. */
export async function saveEdenRulesAction(input: { creativeRules: string }): Promise<{ ok?: true; error?: string }> {
