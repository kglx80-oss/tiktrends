  ...
  return (
    <section style={{ marginBottom: 30 }}>
      <div style={{ display: 'flex', alignItems: 'baseline', gap: 10, marginBottom: 12, flexWrap: 'wrap' }}>
        <h2 style={{ margin: 0, fontSize: 19, fontWeight: 500, color: 'var(--ink)' }}>Diversité créative <span style={{ fontSize: 12, color: 'var(--muted)', fontWeight: 500 }}>· tes générations & tags</span></h2>
      </div>
