...
export function AdsStudio({ ready, aiReady, brandName, initial, products, personas, savedRefs, assets = [], initialMode = 'brand', initialAngle = '', adsmap = false }: {
  ...
  // La grille demande des vignettes · elle affichait des cartes de 240 px et
  // recevait des images de 1080, composées à la demande pour être réduites juste
  // après. L'aperçu et le téléchargement, eux, gardent le plein format.
