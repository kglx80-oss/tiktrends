  ...
  return (
    <main style={{ minHeight: '100vh', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(440px, 100%), 1fr))' }}>
      ...
      <section style={{
        ...
        <div>
          <h2 style={{ fontSize: 'clamp(28px, 4vw, 32px)', fontWeight: 500, lineHeight: 1.15, letterSpacing: '-.02em', maxWidth: 420 }}>
          ...
          <p style={{ marginTop: 14, color: 'var(--ink-2)', fontSize: 14, maxWidth: 420, lineHeight: 1.6 }}>
            Radar prescriptif, tagging IA, Veille concurrentielle et gestion multi-marques,
