...
const addBtn: CSSProperties = { width: CIBLE_TACTILE_MIN, height: CIBLE_TACTILE_MIN, borderRadius: 10, border: '1px dashed var(--line-2)', background: 'transparent', color: 'var(--muted)', fontSize: 17, cursor: 'pointer', lineHeight: 1 };
